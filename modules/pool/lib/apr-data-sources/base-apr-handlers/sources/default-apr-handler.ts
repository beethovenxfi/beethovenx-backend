...
const wstETHOptimism = '0x1f32b1c2345538c0c6f582fcb0227;39c4a194ebb';
...
export const overnightLpUsdcUsdPlusMainnet = '0x1aafc31091d93c3ff003cff5d2d8f7ba2e728425';
export const overnightUsdcUsdPlusMainnet = '0x6933ec1ca55c06a894107860c92acdfd2dd8512f';
export const overnightUsdPlusOptimism = '0xa348700745d249c3b49d2c2acac9a5ae8155f826';
export const overnightDaiPlusOptimism = '0x0b8f31480249cc717081928b8af733f45f6915bb';
...
const stETHOptimismAprHandler = new DefaultAprHandler({
    tokens: [wstETHOptimism],
    url: 'https://eth-api.lido.fi/v1/protocol/steth/apr/sma',
    path: 'data.smaApr',
    network: 'OPTIMISM',
});
...
const overnightMainnetAprHandler = new DefaultAprHandler({
    tokens: [overnightLpUsdcUsdPlusMainnet, overnightUsdcUsdPlusMainnet],
...
const overnightUsdPlusOptimismAprHandler = new DefaultAprHandler({
    tokens: [overnightUsdPlusOptimism],
    url: 'https://api.overnight.fi/optimism/usd+/fin-data/avg-apr/week',
    path: 'value',
    network: 'OPTIMISM',
    group: 'OVERNIGHT',
});

const overnightDaiPlusOptimismAprHandler = new DefaultAprHandler({
    tokens: [overnightDaiPlusOptimism],
    url: 'https://api.overnight.fi/optimism/dai+/fin-data/avg-apr/week',
    path: 'value',
    network: 'OPTIMISM',
    group: 'OVERNIGHT',
});
...
export const defaultHandlers = [
    ...
    overnightUsdPlusOptimismAprHandler,
    overnightDaiPlusOptimismAprHandler,
];
